        ...
        <div className='footer'>
           <footer>
                <div className='divFooter'> 
                    ...
                    <h1> Follow Us </h1>
                        <ul>
                            <li><a href='#' target="_black" alt='Email'><i class="bi bi-envelope-fill FIcon01 "/></a></li>
                            <li><a href='#' target="_black" alt='Instagram'><i class="bi bi-instagram FIcon02 "/></a></li>
                            <li><a href='#' target="_black" alt='LinkedIn'><i class="bi bi-linkedin FIcon03 "/></a></li>
                            <li><a href='https://github.com/Ranjithv88/websites' target="_black" alt='GitHub'><i class="bi bi-github FIcon04 "/></a></li>
                        </ul>   
                    </ul>
